...
const jobs: Job[] = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      'Learn directly from senior engineers through mentorship and code review',
    ],
    requirements: [
      ...
      'Strong problem-solving ability and willingness to learn in a collaborative environment',
    ],
    howToApply: 'Browse and apply directly through IBM\'s official careers site — search "entry level" or your target location for current openings.',
    applyUrl: 'https://www.ibm.com/careers/career-opportunities',
    applyLabel: 'Apply on IBM Careers',
    note: 'IBM posts specific entry-level roles continuously rather than a single standing requisition — this links to the general early-career listings page.',
  },
  {
    ...
    category: 'Engineering & Data',
    deadline: 'Rolling — new grad openings posted throughout the recruiting cycle',
    summary: 'Salesforce\'s Futureforce new-grad software engineering track, pairing incoming engineers with mentors and structured onboarding as they join product teams.',
    responsibilities: [
      'Design, build, and ship features on Salesforce\'s core product and platform teams',
      'Collaborate with senior engineers through code review and pair programming',
      'Participate in Salesforce\'s structured new-grad mentorship and learning program',
    ],
    requirements: [
  ...
  {
    id: 'adobe-university-graduate-program',
    title: '2026 University Graduate Program (Engineering / Design / Applied Science)',
    company: 'Adobe',
    location: 'Multiple US locations (San Jose, Seattle, New York, and others)',
    type: 'Full-time / Graduate Program',
    category: 'Engineering & Data',
    deadline: 'Rolling — specific 2026 University Graduate roles posted on an ongoing basis',
    summary: 'Adobe\'s University Graduate track for engineering, applied science, and design roles, building products used in Adobe\'s Creative Cloud and generative AI tools.',
    responsibilities: [
      'Work on production features within engineering, applied science, or design teams',
      'Partner with cross-functional teams on generative AI and real-time collaboration features',
      'Receive structured onboarding and ongoing feedback through Adobe\'s Check-In process',
    ],
    requirements: [
      'Graduating in 2026 (or a very recent graduate) in a relevant technical or design field',
      'Demonstrated project or internship experience relevant to the target role',
      'Strong fundamentals in your discipline (engineering, ML, or design/research, depending on role)',
    ],
    howToApply: 'Search and apply for a specific "2026 University Graduate" posting via Adobe\'s graduate careers hub.',
    applyUrl: 'https://careers.adobe.com/us/en/graduates',
    applyLabel: 'Apply on Adobe Careers',
    note: 'Adobe lists University Graduate openings as individual role-specific postings (Applied Scientist, Associate User Researcher, Software Engineer, etc.) rather than one combined listing — search this hub for the current set.',
  },
  {
    id: 'bain-associate-consultant',
    title: 'Associate Consultant',
    company: 'Bain & Company',
    location: 'Multiple global offices (apply via your target office)',
    type: 'Full-time',
    category: 'Business, Finance & Consulting',
    deadline: 'Varies by office — check your target office\'s page for the current window',
    summary: 'Bain\'s entry point into management consulting for final-year students and candidates with under two years of full-time work experience, working generalist casework alongside senior consultants from day one.',
    responsibilities: [
      'Work directly with client teams to structure and solve business problems',
      'Conduct research, analysis, and synthesis to support client recommendations',
      'Build core consulting skills: analytical, interpersonal, and leadership',
    ],
    requirements: [
      'Final-year student (any degree/university) or under two years of full-time work experience since graduation',
      'Strong analytical, quantitative, and communication skills',
      'No prior consulting experience required',
    ],
    howToApply: 'Applications include an online assessment covering numerical aptitude, logical reasoning, and behavioral preferences. Select your target office\'s recruiting page for exact deadlines — these vary significantly by region.',
    applyUrl: 'https://www.bain.com/careers/hiring-process/associate-consultant/',
    applyLabel: 'Apply on Bain Careers',
    note: 'Deadlines differ substantially by office — e.g. some offices reopen applications later in the year while others recruit continuously. Confirm your specific office\'s window before applying.',
  },
  {
    ...
    category: 'Business, Finance & Consulting',
    deadline: 'Annual cycle — 2026-intake applications typically open in early autumn',
    summary: 'Visa\'s early-career umbrella covering internships and the Leadership Associate Program (VLA), a two-year rotational program building broad commercial and payments-industry experience.',
    responsibilities: [
      'Rotate across four distinct six-month assignments over two years (VLA track)',
      'Build foundational knowledge of Visa\'s global payments business',
    ...
    requirements: [
      ...
      'Willingness to relocate for rotational assignments, where applicable',
    ],
    ...
    note: 'Visa\'s early-career recruiting runs on an annual calendar (roughly September–November for the following year\'s intake) — confirm current-cycle dates on the site before applying.',
  },
  {
    id: 'morgan-stanley-students-graduates',
    title: 'Analyst & Associate Programs (Students & Graduates)',
    company: 'Morgan Stanley',
    location: 'Multiple global offices',
    type: 'Full-time / Graduate Program',
    category: 'Business, Finance & Consulting',
    deadline: 'Varies by program — Investment Banking and Early Insights cycles typically open in Feb–March',
    summary: 'Morgan Stanley\'s umbrella of full-time analyst and associate programs across investment banking, wealth management, technology, and research for students and recent graduates.',
    responsibilities: [
      'Join a specific division (e.g. Investment Banking, Wealth Management, Technology) as a full-time analyst',
      'Support live client and internal projects under senior guidance',
      'Complete structured onboarding/training specific to your division',
    ],
    requirements: [
      'Final-year student or recent graduate; specific degree requirements vary by division',
      'Strong quantitative, analytical, and communication skills',
      'Some divisions run separate early-insights/diversity pipeline programs — check eligibility per program',
    ],
    howToApply: 'Search Morgan Stanley\'s Students & Graduates portal for the specific division and program you\'re targeting — timelines differ by division.',
    applyUrl: 'https://www.morganstanley.com/people-opportunities/students-graduates',
    applyLabel: 'Apply on Morgan Stanley Careers',
  },
  {
    id: 'unicef-careers-vacancies',
    title: 'Entry-Level & Early-Career Vacancies (Various Fields)',
    company: 'UNICEF',
    location: 'Global — headquarters, regional, and country offices',
    type: 'Consultancy / Internship / Fixed-term (varies by posting)',
    category: 'Policy, Government & Nonprofit',
    deadline: 'Rolling — new vacancies posted continuously; each has its own closing date',
    summary: 'UNICEF\'s global careers portal lists current openings across child protection, education, health, nutrition, WASH, social policy, supply chain, and emergency response.',
    responsibilities: [
      'Varies by specific posting — review the individual vacancy for scope',
      'Entry points include internships, individual contractor roles, and National Officer/General Service positions',
    ],
    requirements: [
      'Varies by posting — most require a relevant degree and, for internships, current enrollment or recent graduation',
      'UNICEF does not charge fees at any stage of recruitment and never requests banking information',
    ],
    howToApply: 'Create an online recruitment profile and apply to individual vacancies directly through UNICEF\'s careers portal; you can also set a job alert for your field of interest.',
    applyUrl: 'https://jobs.unicef.org/',
    applyLabel: 'Browse UNICEF Vacancies',
    note: 'This links to the live vacancies portal rather than one specific role — UNICEF posts and closes individual positions on a rolling basis, each with its own deadline.',
  },
  {
    id: 'who-internship-programme',
    title: 'WHO Internship Programme',
    company: 'World Health Organization (WHO)',
    location: 'Geneva HQ, six regional offices, and country offices worldwide',
    type: 'Internship',
    category: 'Policy, Government & Nonprofit',
    deadline: 'Rolling — internship postings open throughout the year, each with its own deadline',
    summary: 'Hands-on internship placements across public health, medicine, communications, engineering, law, data science, and administration, working alongside WHO\'s global health experts.',
    responsibilities: [
      'Support ongoing project work within your assigned team/department',
      'Contribute to research, analysis, or communications relevant to WHO\'s public health mandate',
    ],
    requirements: [
      'Currently enrolled student or recent graduate in a relevant field',
      'Strong written and spoken English (additional UN languages an asset)',
    ],
    howToApply: 'Create a Stellis profile on WHO\'s official careers portal and apply to specific internship postings as they open.',
    applyUrl: 'https://careers.who.int',
    applyLabel: 'Apply on WHO Careers Portal',
    note: 'Interns receive a living allowance and medical/accident insurance, but the programme is unpaid in the traditional salary sense — confirm current terms on the portal.',
  },
  {
    id: 'unhcr-internship-programme',
    title: 'UNHCR Internship Programme',
    company: 'UNHCR (UN Refugee Agency)',
    location: 'Global — HQ and field/country offices',
    type: 'Internship (2–6 months, extendable up to 12)',
    category: 'Policy, Government & Nonprofit',
    deadline: 'Rolling — individual postings each carry their own deadline',
    summary: 'A structured internship for students and recent graduates to gain hands-on experience in the humanitarian and refugee-protection sector within an international environment.',
    responsibilities: [
      'Support the work of your assigned team (e.g. legal protection, community services, public affairs, health)',
      'Contribute to ongoing operational or policy work under staff supervision',
    ],
    requirements: [
      'Currently pursuing, or recently completed, an undergraduate/graduate degree in a relevant field',
      'Strong written and spoken English; additional languages an asset depending on duty station',
    ],
    ...
    applyUrl: 'https://www.unhcr.org/us/careers-unhcr',
    applyLabel: 'Apply via UNHCR Careers',
    note: 'Highly competitive — UNHCR recommends applying as early as possible once a relevant posting opens.',
  },
  {
    id: 'airbnb-early-careers',
    title: 'Early Careers Internship Programs',
    company: 'Airbnb',
    location: 'Multiple locations (details vary by role)',
    type: 'Internship',
    category: 'Design, Marketing & Ops',
    deadline: 'Rolling — apply as early as possible after a role posts',
    summary: 'Airbnb\'s internship programs put students on high-exposure projects from day one, with a goal of converting strong interns into full-time offers.',
    responsibilities: [
      'Own meaningful project work within your assigned team from the start of the internship',
      'Partner with cross-functional teams (product, design, marketing, or operations, depending on track)',
    ],
    requirements: [
      'Currently enrolled student, graduating within the program\'s eligible window',
      'Relevant coursework or prior internship experience for your target track',
    ],
    howToApply: 'Apply directly through Airbnb\'s careers site — Airbnb notes that applying within the first few hours of a posting going live improves your chances given high volume.',
    applyUrl: 'https://careers.airbnb.com/internship-programs/',
    applyLabel: 'Apply on Airbnb Careers',
  },
  {
    id: 'hubspot-emerging-talent',
    title: 'Emerging Talent Program (Entry-Level & Co-op)',
    company: 'HubSpot',
    location: 'Multiple locations (remote-eligible for some roles)',
    type: 'Full-time / Co-op (6 months)',
    category: 'Design, Marketing & Ops',
    deadline: 'Rolling — co-op windows apply early Fall (for Spring start) or early Spring (for Fall start)',
    summary: 'HubSpot\'s Emerging Talent track for recent graduates and career changers, spanning software engineering, product management, marketing, legal, finance, and people operations.',
    responsibilities: [
      'Take on real, team-embedded work rather than a shadow/observation role',
      'Complete structured onboarding, training, and workshops during ramp-up',
    ],
    requirements: [
      'Recent graduate or career changer new to the field',
      'No specific degree required — HubSpot explicitly welcomes non-traditional backgrounds',
    ],
    howToApply: 'Browse current openings on HubSpot\'s Emerging Talent careers page and apply directly.',
    applyUrl: 'https://www.hubspot.com/careers/emerging-talent',
    applyLabel: 'Apply on HubSpot Careers',
  },
  {
    id: 'canva-early-careers-launchpad',
    title: 'Launchpad Early Careers Program',
    company: 'Canva',
    location: 'Australia / New Zealand (with some remote-eligible tracks)',
    type: 'Full-time / 12-month Program',
    category: 'Design, Marketing & Ops',
    deadline: 'Annual intake — 2026/2027 program applications open on a yearly cycle',
    summary: 'Canva\'s 12-month professional development program (Launchpad) for early-career talent across engineering, design, marketing, and business functions, paired with a coach and program manager.',
    responsibilities: [
      'Work across key business areas with structured coaching and mentorship',
      'Complete a role-relevant assessment during the application process (e.g. a coding challenge or video reel)',
    ],
    requirements: [
      'Final-year student, or up to two years of experience in your chosen field',
      'Strong alignment with Canva\'s stated values and mission',
    ],
    howToApply: 'Apply online via Canva\'s Early Careers page; shortlisted candidates complete a role-relevant task before a recruiter chat.',
