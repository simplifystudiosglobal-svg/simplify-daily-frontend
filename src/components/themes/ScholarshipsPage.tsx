...
const scholarships: Scholarship[] = [
  ...
  {
    id: 'apri',
    name: 'APRI Young Talent Program',
    sponsor: 'Africa Policy Research Institute (APRI)',
    location: 'Berlin, Germany / Abuja, Nigeria (remote-friendly)',
    ...
    summary: 'APRI is a Berlin-based, independent policy institute researching key issues affecting the African continent, across economy & society, technology, and climate change. The Young Talent Program offers hands-on experience with its Geopolitics and Geoeconomics research team.',
    coverage: [
      'Direct research and advocacy experience at a growing policy think tank',
      'Two intake cohorts, with the next commencing January 2027',
    ],
    eligibility: [
      'EU-enrolled applicants: must be completing a mandatory university internship (Pflichtpraktikum)',
      'Africa-based or other regions: may apply if recently graduated or between academic programs; must be available on GMT+1 or GMT+2 working hours',
      'Strong research, analytical, data, and media-monitoring skills; excellent written and spoken English',
      'Preferred: graduate studies in International Relations, Political Economy, Development Studies, or African Studies',
    ],
    howToApply: 'Apply through the official Google Form application (requires signing in with a Google account). Applications are reviewed on a rolling basis by APRI\'s Geopolitics and Geoeconomics program; shortlisted candidates may be held on a reserve roster for future openings.',
    applyUrl: 'https://docs.google.com/forms/d/e/1FAIpQLSfZmsNImr1NhV_rlVd_4E3GQW7LzB_9WXV-fH0WE_caUJBFXA/viewform',
    applyLabel: 'Apply via Google Form',
    infoUrl: 'https://jobs.afripoli.org/en?id=b50354',
    note: 'Compensation/stipend for this program is not stated on the official listing — confirm directly with APRI before applying. The application form requires a Google account sign-in.',
  },
  {
    id: 'unitar',
    name: 'UNITAR Development Programme for Sub-Saharan Africa',
    sponsor: 'United Nations Institute for Training and Research (UNITAR)',
    location: 'Botswana, Ethiopia, Ghana, Kenya, Nigeria, Rwanda, South Africa, Tanzania, Uganda, Zambia, Zimbabwe',
    level: 'Training',
    deadline: 'July 31, 2026',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Geneve_2005_001_Ork.ch.jpg/1280px-Geneve_2005_001_Ork.ch.jpg',
    summary: 'A multi-phase capacity development programme under the Tokyo International Conference on African Development (TICAD9), run by UNITAR with support from the Government of Japan, to help African youth and women turn ideas into investment-ready initiatives.',
    coverage: [
      'Structured mentorship and applied learning across four phases (Aug 2026 – Mar 2027)',
      'Ecosystem exposure and international engagement opportunities',
      'Support developing partnership-ready, investment-oriented project proposals',
    ],
    eligibility: [
      'Youth and women professionals aged 18–35 from the listed Anglophone Sub-Saharan African countries',
      'Aspiring/early-stage entrepreneurs, SME founders, researchers, or social entrepreneurs',
      'A clear project or business idea with implementation potential',
    ],
    howToApply: 'Apply through the UNITAR event platform. Progression through the programme\'s phases is competitive, based on performance, leadership, and feasibility of the proposed project.',
    applyUrl: 'https://event.unitar.org/user/login?destination=/product/15337/application',
    applyLabel: 'Apply via UNITAR Portal',
    infoUrl: 'https://event.unitar.org/full-catalog/empowering-youth-and-women-amid-economic-instability-enhancing-public-private',
  },
  {
    id: 'slovak',
    name: 'Government of Slovak International Scholarship',
    sponsor: 'Government of the Slovak Republic',
    location: 'Slovakia',
    ...
    summary: 'A scholarship of up to €15,000 for international students (including Slovaks living abroad) pursuing full-time bachelor\'s or master\'s studies at a public Slovak higher education institution in 2026/2027.',
    coverage: [
      'Scholarship award of up to €15,000',
    ],
    eligibility: [
      'Citizenship of a country other than Slovakia (dual citizenship allowed)',
      'No permanent residence in Slovakia since January 1, 2021',
      'Admission (or application) to a supported bachelor\'s or master\'s programme at a public Slovak HEI',
      'Minimum SAT score of 1100, or SCIO average percentile of 63',
    ],
    howToApply: 'Register and apply through the Slovak scholarship portal. A step-by-step registration guide is available from the official site.',
    applyUrl: 'https://scholarships.portalvs.sk/front.auth/login',
    applyLabel: 'Apply via Slovak Portal',
    infoUrl: 'https://scholarships.portalvs.sk/',
  },
  {
    id: 'lego',
    name: 'LEGO Foundation Fellowship',
    sponsor: 'LEGO Foundation',
    location: 'Any country (except those under EU/US sanctions)',
    level: 'Fellowship (Research)',
    deadline: 'July 31, 2026',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/LEGO_logo.svg/1280px-LEGO_logo.svg.png',
    summary: 'A global research fellowship for early- and mid-career researchers studying how children thrive across diverse contexts, with flexible funding administered through the fellow\'s host institution.',
    coverage: [
      'USD 300,000 in flexible research funding over three years (inclusive of 15% indirect costs)',
      'Funds cover research personnel, professional travel, equipment, and dissemination',
      'Membership in a cross-disciplinary cohort of fellows, with convenings hosted by the LEGO Foundation',
    ],
    eligibility: [
      'PhD or equivalent research doctorate held by July 31, 2026, received no earlier than January 1, 2016',
      'Employed by a university or research institute at the start of the fellowship',
      'A clear, original research agenda tied to one or more fellowship themes',
    ],
    howToApply: 'Apply through the SSRC online application portal by July 31, 2026, 11:59 EST. Required materials include a CV, research abstract, personal statement, 5-page research proposal, and budget justification.',
    applyUrl: 'https://ssrc.secure-platform.com/a/solicitations/1180/home',
    applyLabel: 'Apply via SSRC Portal',
  },
  {
    id: 'lit-uganda',
    name: 'LIT-Uganda Female STEM Student Teachers Scholarship',
    sponsor: 'Luigi Giussani Foundation (LGF), part of the Mastercard Foundation\'s Leaders in Teaching Uganda initiative',
    location: 'Uganda',
    level: 'Undergraduate',
    deadline: 'July 31, 2026',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Urban_Rising%2C_KAMPALA%2C_Uganda.jpg/1280px-Urban_Rising%2C_KAMPALA%2C_Uganda.jpg',
    summary: 'Part of a five-year Mastercard Foundation programme to transform secondary education in Uganda, this scholarship supports young women training as STEM teachers, with emphasis on equity for refugees and persons with disabilities.',
    coverage: [
      'Tuition and functional fees',
      'Accommodation costs',
      'A laptop to support academic studies',
    ],
    eligibility: [
      'Female Ugandan citizens, refugees, or youth with disabilities, aged 18–35',
      'Admission offer for a Bachelor of Science with Education (BScEd) at a LiT partner university or UNITE campus',
      'Commitment to teach in rural or underserved secondary schools for at least 2 years',
      'Demonstrated financial need',
    ],
    howToApply: 'Register and apply through the LGF scholarship portal.',
    applyUrl: 'https://scholarships.lgfug.org/register',
    applyLabel: 'Apply via LGF Portal',
    infoUrl: 'https://scholarships.lgfug.org/',
  },
  {
    id: 'russia',
  ...
  {
    id: 'albukhary',
    name: 'Albukhary International University Undergraduate Scholarship',
    sponsor: 'Albukhary International University',
    location: 'Malaysia',
    level: 'Undergraduate',
    deadline: 'July 31, 2026',
    ...
    summary: 'Established in 2005 to give underprivileged students access to higher education at no cost, open to both Malaysian and international students, with an emphasis on community service.',
    coverage: [
      'Tuition fees, accommodation, and meal allowances',
      'Does not cover flights, visa processing (EMGS), or personal bond',
    ],
    eligibility: [
      'International applicants: aged 17–20',
      'Household income of USD 300/month or below (international category)',
      'English proficiency (e.g. IELTS overall band 5–6, depending on programme)',
    ],
    howToApply: 'Submit your application directly through the university\'s online application system.',
    applyUrl: 'https://aiu.edu.my/apply-now/submit-your-application/',
    applyLabel: 'Submit Application',
    infoUrl: 'https://aiu.edu.my/apply-now/accepting-your-offer/',
  },
  {
    id: 'koica',
    name: 'KOICA Scholarship Program',
    sponsor: 'Korea International Cooperation Agency (KOICA), Government of Korea',
    location: 'South Korea',
    level: 'Postgraduate (Masters / Doctoral)',
    deadline: 'July 31, 2026',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/%EC%A4%91%ED%99%94%EC%A0%84%EC%9D%98_%EB%82%AE.jpg/1280px-%EC%A4%91%ED%99%94%EC%A0%84%EC%9D%98_%EB%82%AE.jpg',
    summary: 'Trains future leaders from KOICA partner countries through 11 master\'s and 4 doctoral programmes, aimed at fostering socio-economic development back home.',
    coverage: [
      'Tuition, monthly allowance, airfare, and accommodation',
      'Settlement allowance, completion grant, and insurance',
    ],
    eligibility: [
      'Citizen of a KOICA partner country, officially recommended by their government',
      'Bachelor\'s degree holder (master\'s track); master\'s degree holder (doctoral track)',
      'Public official or publicly-affiliated worker',
    ],
    howToApply: 'Two-stage process: apply through the KOICA overseas office or Korean Embassy first (KOICA Round), then through the chosen university (University Round, for those who pass).',
    applyUrl: 'https://www.koica.go.kr/ciat/7815/subview.do',
    applyLabel: 'Official KOICA Page',
    note: 'Review each partner university\'s specific programme information on the KOICA site before applying.',
  },
  {
    id: 'ahaki',
    name: 'Ahaki Institute Scholarship for Africans',
    sponsor: 'Afya na Haki (Ahaki) Institute',
    location: 'Uganda',
    level: 'Undergraduate / Postgraduate Diploma',
    deadline: 'July 31, 2026',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Urban_Rising%2C_KAMPALA%2C_Uganda.jpg/1280px-Urban_Rising%2C_KAMPALA%2C_Uganda.jpg',
    summary: 'Supports students in Ahaki\'s Bachelor\'s and Postgraduate Diploma programmes in Sexual and Reproductive Health (SRH), fostering a new generation of African leaders in health, human rights, and social justice.',
    coverage: [
      'Full or partial tuition fees, depending on need and available funding',
      'Research-related and travel costs where necessary',
    ],
    eligibility: [
      'African citizens residing in an African country',
      'Accepted into Ahaki\'s Bachelor\'s or Postgraduate Diploma programme in SRH',
      'Demonstrated commitment to reproductive justice and leadership potential',
    ],
    howToApply: 'You must first apply to an Ahaki academic programme, then submit a separate scholarship application including a personal statement, CV, and reference letter.',
    applyUrl: 'https://www.ahakiinstitute.ac/scholarship-application/',
    applyLabel: 'Official Scholarship Page',
  },
  {
    id: 'sabanci',
